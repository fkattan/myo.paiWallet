...
const getDailingCode = (isoCode: string): string | null => {
  ...
  if (isoCode) {
    ...
    match = dailingCodes.find((dc) => {
      return dc.isoCode === isoCode;
    });
  }
  return match ? match.dialCode : null;
};

/**
 * given a list of phone numbers, returns the list of potential full numbers
 * by taking into account the iso Country code and using it as context.
 * Returned list will be a list of phone numbers in E164 format.
 * @param phoneNumbers
