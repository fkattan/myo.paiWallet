...
export interface L2PaiContract extends Truffle.Contract<L2PaiInstance> {
  "new"(
    _childChainManagerProxy: string,
    meta?: Truffle.TransactionDetails
  ): Promise<L2PaiInstance>;
}
...
export interface L2PaiInstance extends Truffle.ContractInstance {
