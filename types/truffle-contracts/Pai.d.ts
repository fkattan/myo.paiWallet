...
export interface PaiContract extends Truffle.Contract<PaiInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<PaiInstance>;
}
...
export interface PaiInstance extends Truffle.ContractInstance {
